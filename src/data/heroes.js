...
const heroesData = {
  strength: [
    ...
    kunkka, legionCommander, lifestealer, lycan, magnus, mars, omniknight, phoenix,
  ...
  agility: [
    ...
    emberSpirit, facelessVoid, gyrocopter, juggernaut, loneDruid, medusa, meepo,
  ...
  carry: [
    ...
    lina, necrophos, queenOfPain, silencer, techies, voidSpirit, windranger
  ],
  support: [
    ...
    bountyHunter, mirana, nyxAssassin, pangolier, vengefulSpirit, venomancer, ancientApparition,
  ...
  hardlane: [
    ...
    dragonKnight, elderTitan, huskar, kunkka, legionCommander, lycan, mars, omniknight,
